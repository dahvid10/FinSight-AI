            ...
            <label className="block text-sm font-medium text-gray-300 mb-2">Monthly Savings Goal</label>
             <div className="flex items-center gap-x-6 gap-y-2 flex-wrap mb-2">
                <div className="flex items-center">
                    ...
                    <label htmlFor="goal-percentage" className="ml-2 block text-sm text-gray-200">Percentage (%)</label>
                </div>
                <div className="flex items-center">
                    ...
                    <label htmlFor="goal-amount" className="ml-2 block text-sm text-gray-200">Fixed Amount ($)</label>
                </div>
            </div>
            <Input 
              id="savingsGoalValue" 
            ...
            {budgetInput.expenses.map((expense, index) => (
              <div key={expense.id} className="grid grid-cols-1 sm:grid-cols-8 gap-3 items-center">
                ...
                <div className="sm:col-span-1 flex justify-end">
                    <button type="button" onClick={() => removeExpense(expense.id)} className="p-2 text-gray-500 hover:text-red-500 hover:bg-gray-700 rounded-full transition-colors">
